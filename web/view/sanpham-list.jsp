    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="${pageContext.request.contextPath}/export-excel?type=product&keyword=${param.keyword}&loaiId=${param.loaiId}" 
                       class="btn btn-success fw-bold px-3 py-2 me-2" 
